    ...
    case "ADD_FILES": {
      const newFiles = action.payload
        .map((f) => ({
          ...
          // ClassOverview reuses a roster-picked name); otherwise
          // auto-fill from the filename's first token (teacher
          // convention of "Name [rest].docx"). The teacher can still
          // edit the field in the row before marking.
