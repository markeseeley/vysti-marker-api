...
const studentReactMainPath = path.join(
  repoRoot,
  "assets",
  "student-react",
  "main.js"
...
const mainJs = await readFile(studentReactMainPath, "utf8");
if (mainJs.includes('backgroundColor:"rgba(11, 98, 214, 0.6)"')) {
  throw new Error(
    "Detected legacy all-blue MCI chart color in assets/student-react/main.js."
  );
}
